...
<!-- saved from url=(0037)http://robla.net/1996/svg2swf/svg2swf -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">#!/usr/bin/python
